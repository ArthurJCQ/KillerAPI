 ...
 */
final class Version20230416182459 extends AbstractMigration
{
...
//        $this->addSql('DROP INDEX "primary"');
        $this->addSql('ALTER TABLE room RENAME COLUMN code TO id');
//        $this->addSql('ALTER TABLE room ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room RENAME COLUMN id TO code');
